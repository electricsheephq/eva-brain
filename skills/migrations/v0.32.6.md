...
This document records the operator-facing migration note for v0.32.6.
Runtime schema changes are handled by the compiled TypeScript/SQL migration
path; this markdown is a human/agent reference, not an automatically executed
migration.
