...
```
# Old:
node /path/to/your-openclaw/workspace/scripts/upload-raw-source.mjs <file> \
...
```
# Old:
node /path/to/your-openclaw/workspace/scripts/brain-publish.mjs <page> --password
...
```
# Old:
node /path/to/your-openclaw/workspace/scripts/save-report.mjs \
