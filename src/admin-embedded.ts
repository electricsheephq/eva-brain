...
import A_0_assets_index_DlF4rPGd_js from '../admin/dist/assets/index-DlF4rPGd.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-DlF4rPGd.js": { path: A_0_assets_index_DlF4rPGd_js as unknown as string, mime: "application/javascript; charset=utf-8" },
